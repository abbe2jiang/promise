package org.dj.we.service.author;

import org.dj.we.domain.Author;
import org.dj.we.domain.Image;
import org.dj.we.repository.AuthorMongoRepository;
...
public class AuthorService {
    ...
    public void updateByUsername(String username, String portrait, String firstName,
            String lastName, String brief) {
        ...
        Update update = Update.update("portrait", image).set("firstName", firstName)
                .set("lastName", lastName).set("brief", brief)
                .set("updateTime", System.currentTimeMillis());
        template.updateFirst(Query.query(Criteria.where("username").is(username)), update,
                Author.class);
    }
    ...
    public void updateBioByUsername(String username, String title, String content) {
        ...
        Update update = Update.update("bio", bio).set("updateTime", System.currentTimeMillis());
        template.updateFirst(Query.query(Criteria.where("username").is(username)), update,
                Author.class);
    }
