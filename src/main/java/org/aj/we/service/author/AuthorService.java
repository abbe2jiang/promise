...
public class AuthorService {
  ...
  @Autowired AuthorMongoRepository authorMongoRepository;
  ...
  public void updateByUsername(String username, String portrait,
    ...
    template.updateFirst(Query.query(Criteria.where("username").is(username)),
                         update, Author.class);
  }

  public void updateBioByUsername(String username, String title,
                                  String content) {
    Author.Bio bio = new Author.Bio();
    bio.setTitle(title);
    bio.setContent(content);
    Update update =
        Update.update("bio", bio).set("updateTime", System.currentTimeMillis());
    template.updateFirst(Query.query(Criteria.where("username").is(username)),
                         update, Author.class);
  }
